package com.magiclon.individuationtoast;
...
public class ToastUtil {
    ...
    public static void shownormal(@NonNull Context context,@NonNull String message) {
    ...
    public static void shownormal(@NonNull Context context,@NonNull String message, int duration) {
        normal(context, message, duration, null, false).show();
    }

    public static void shownormal(@NonNull Context context,@NonNull String message, int duration, Drawable icon) {
        normal(context, message, duration, icon, true).show();
    }

    public static Toast shownormal(@NonNull Context context,@NonNull String message, int duration, Drawable icon, boolean withIcon) {
    ...
    public static void showwarning(@NonNull Context context,@NonNull String message, int duration) {
        warning(context, message, duration, true).show();
    }

    public static Toast showwarning(@NonNull Context context,@NonNull String message, int duration, boolean withIcon) {
    ...
    public static Toast showinfo(@NonNull Context context,@NonNull String message, int duration, boolean withIcon) {
    ...
    public static Toast showsuccess(@NonNull Context context,@NonNull String message, int duration, boolean withIcon) {
    ...
    public static Toast showerror(@NonNull Context context,@NonNull String message, int duration, boolean withIcon) {
    ...
    public static boolean doubleClickExit(Context context) {
        if ((System.currentTimeMillis() - mExitTime) > 2000) {
            ToastUtil.shownormal(context,"再按一次退出");
